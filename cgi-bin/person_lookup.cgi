...
<CENTER>
<HEAD>
<TITLE> SUNSA Person Information Service </TITLE>

<SCRIPT LANGUAGE="JavaScript">
	<!-- HIDE THIS from other Browsers
	 
	function No_Node(form) {
		alert("You must specify something for search");
	}
	
	function display_values(form) {
		var node = form.Node.value ;
	
		alert("Person is:" + node + ":") ;
	}
...
<H1>
<font color="blue">
SUNSA Person Information Service
</font>
...
Use "ALL" for full list getting
<br>
</font>
<BR>
<CENTER>
<FORM METHOD="GET" ACTION="person_list.cgi">
